        ...
        <form method="POST" action="edit_process" class="input_form">
            ...
            <ul class="inputs">
                <li class="input_parts">
                    ...
                    <input id="last_name" type="text" name="last_name" @if(old('last_name')!=null) value="{{ old('last_name') }}" @elseif(Auth::user()->last_name!=null) value="{{ Auth::user()->last_name }}" @endif @if ($errors->has('last_name')) class="input_alert" @endif placeholder="山田" required autofocus>
                ...
                <li class="input_parts">
                    ...
                    <input id="last_name_furigana" type="text" name="last_name_furigana" @if(old('last_name_furigana')!=null) value="{{ old('last_name_furigana') }}" @elseif(Auth::user()->last_name_furigana!=null) value="{{ Auth::user()->last_name_furigana }}" @endif @if ($errors->has('last_name_furigana')) class="input_alert" @endif placeholder="ヤマダ" required autofocus>
