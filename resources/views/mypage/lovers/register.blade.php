        ...
        <form action="/mypage/lovers/register_process" method="POST" enctype='multipart/form-data' class="input_form">
            ...
            <ul class="inputs">
                ...
                <li class="input_parts">
                    ...
                    <input id="last_name_furigana" type="text" name="last_name_furigana" value="{{ old('last_name_furigana') }}" placeholder="ヤマダ" @if ($errors->has('last_name_furigana')) class="input_alert" @endif required >
                    @foreach ($errors->get('last_name_furigana') as $error)
                        <p class="form_alert">{{ $error }}</p>
                    @endforeach
                </li>
                <li class="input_parts">
                    ...
                    @foreach ($errors->get('first_name_furigana') as $error)
                        <p class="form_alert">{{ $error }}</p>
                    @endforeach
                </li>
                <li class="input_parts">
                ...
                <lover-img-component :err-msgs='@json($errors->get('image'))'></lover-img-component>
            </ul>
            <div class="btns">
                <button>登録</button>
            </div>
