                ...
                <div v-if="dataCartGoods.length > 0" id="od_cards">
                    <div v-for="dataProduct in dataCartGoods" :key="dataProduct.id" class="product_card">
                        <a :href="'/product?id='+dataProduct.product.id">
                            <img :src="s3Directory+('00000'+dataProduct.product.id).slice( -5 )+'.jpg'" :alt="dataProduct.title" class="product_card_img" v-if="s3Directory!=null">
                            <img :src="'/image/products/'+('00000'+dataProduct.product.id).slice( -5 )+'.jpg'" :alt="dataProduct.title" class="product_card_img" v-else>
                ...
                <div v-else id="od_cards">
                    <div v-for="(dataProduct,i) in dataProducts" :key="dataProduct.id" class="product_card">
                        <a :href="'/product?id='+dataProduct.id">
                            <img :src="s3Directory+('00000'+dataProduct.id).slice( -5 )+'.jpg'" :alt="dataProduct.title" class="product_card_img" v-if="s3Directory!=null">
                            <img :src="'/image/products/'+('00000'+dataProduct.id).slice( -5 )+'.jpg'" :alt="dataProduct.title" class="product_card_img" v-else>
