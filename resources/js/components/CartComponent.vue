                ...
                <div v-else id="od_cards">
                    <div v-for="(dataProduct,i) in dataProducts" :key="dataProduct.id" class="product_card">
                        <a :href="'/product?id='+dataProduct.id">
                            <img :src="s3Directory+('00000'+dataProduct.id).slice( -5 )+'.png'" :alt="dataProduct.title" class="product_card_img" v-if="s3Directory!=null">
                            <img :src="'/image/products/'+('00000'+dataProduct.id).slice( -5 )+'.png'" :alt="dataProduct.title" class="product_card_img" v-else>
